...
CREATE TABLE PrestamoEquipos (
    ...
    fecha_devolucion DATETIME,                   -- Fecha y hora en la que se devo	lvió el equipo (puede ser nula mientras no se devuelva)
