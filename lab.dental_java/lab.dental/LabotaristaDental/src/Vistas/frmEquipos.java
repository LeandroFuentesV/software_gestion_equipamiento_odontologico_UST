...
public class frmEquipos extends javax.swing.JFrame {
    ...
    private static frmEquipos instancia;
         ...
         tblEquipos.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if (!e.getValueIsAdjusting()) { // Solo si la selección ha terminado
                    if (tblEquipos.getSelectedRowCount() > 0) {
    ...
    public static frmEquipos getInstancia() {
        return instancia;
    }
    ...
    public void mostrarEquipos() {
        ...
        DefaultTableModel modelo = equipos.mostrarEquipos();
    ...
    private void initComponents() {
        ...
        iconEquipos = new javax.swing.JLabel();
        ...
        iconEquipos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/setting.png"))); // NOI18N
        jPanel4.add(iconEquipos, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, 80, -1));
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        btnAgregar.setBackground(new Color(0, 119, 103));
        frmModalEquipo obEquipo = new frmModalEquipo(this, true);
        obEquipo.setVisible(true);
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (filaSeleccionada != -1) {
            Object indice = tblEquipos.getValueAt(filaSeleccionada, 0);
            long IDAntigua = Long.parseLong(indice.toString());

            frmModalModificarEquipo obModificarEquipo = new frmModalModificarEquipo(this, true, IDAntigua);
            obModificarEquipo.setVisible(true);
        } else {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        int filaSeleccionada = tblEquipos.getSelectedRow();
        Object indice = tblEquipos.getValueAt(filaSeleccionada, 0);
        long id = Long.parseLong(indice.toString());
        DAO dao = new DAO();
    ...
    private void btnExportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportarActionPerformed
        ...
        try {
            objeto = new Exportar();
            objeto.exportarExcel(tblEquipos);
    ...
    private javax.swing.JLabel iconEquipos;
