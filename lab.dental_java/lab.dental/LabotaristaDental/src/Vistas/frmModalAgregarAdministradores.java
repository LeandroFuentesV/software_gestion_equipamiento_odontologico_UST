 ...
 * @author forlif3
 */
public class frmModalAgregarAdministradores extends javax.swing.JDialog {

    /**
     * Creates new form frmModalAgregarAdministradores
     */
    public frmModalAgregarAdministradores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
    ...
    private void initComponents() {
        ...
        jPanel2.add(sptCorreo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 700, 340, 20));
        ...
        jPanel2.add(txtContrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 650, 340, 50));
        ...
        jPanel2.add(lblCorreo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 620, -1, -1));

        iconCorreo1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/contrasenia.png"))); // NOI18N
        jPanel2.add(iconCorreo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 660, -1, -1));
        ...
        jPanel2.add(btnCerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 730, 190, 50));
        ...
        jPanel2.add(btnAceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 730, 190, 50));

        lblCorreo.setFont(new java.awt.Font("Roboto", 1, 20)); // NOI18N
        lblCorreo.setForeground(new java.awt.Color(102, 102, 102));
        lblCorreo.setText("Correo");
        jPanel2.add(lblCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 520, -1, -1));
        jPanel2.add(sptCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 600, 340, 20));
        ...
        jPanel2.add(txtCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 550, 340, 50));

        iconCorreo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/correeo.png"))); // NOI18N
        jPanel2.add(iconCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 560, -1, -1));
        jPanel2.add(sptSemestre, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 500, 340, 20));
        ...
        jPanel2.add(iconStetting, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 20, -1, -1));
        ...
        jPanel2.add(txtSemestre, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 450, 340, 50));

        lblSemestre.setFont(new java.awt.Font("Roboto", 1, 20)); // NOI18N
        lblSemestre.setForeground(new java.awt.Color(102, 102, 102));
        lblSemestre.setText("Semestre");
        jPanel2.add(lblSemestre, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 420, -1, -1));

        iconSemestre.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/semestre.png"))); // NOI18N
        jPanel2.add(iconSemestre, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 460, -1, -1));

        iconCarrera.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/carrera.png"))); // NOI18N
        jPanel2.add(iconCarrera, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 360, -1, -1));
        ...
        jPanel2.add(txtCarrera, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 350, 340, 50));
        jPanel2.add(sptCarrera, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 400, 340, 20));
        ...
        jPanel2.add(lblEstudiante3, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 320, -1, -1));
        jPanel2.add(sptNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 300, 340, 20));
        ...
        jPanel2.add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 250, 340, 50));

        lblNombre.setFont(new java.awt.Font("Roboto", 1, 20)); // NOI18N
        lblNombre.setForeground(new java.awt.Color(102, 102, 102));
        lblNombre.setText("Nombre");
        jPanel2.add(lblNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 220, -1, -1));

        iconNombre.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/IconUserEstudiante.png"))); // NOI18N
        jPanel2.add(iconNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 260, -1, -1));
        ...
        jPanel2.add(lblRUT, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 120, -1, -1));

        iconRUT.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/iconRUT.png"))); // NOI18N
        jPanel2.add(iconRUT, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 160, -1, -1));
        jPanel2.add(sptRUT, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 200, 340, 20));
        ...
        jPanel2.add(txtRUT, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 150, 340, 50));
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
       ...
       String tipo_usuario="Docente";
        ...
        if (txtRUT.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Debes ingresar un rut.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        // Crear una instancia de la clase DAO y llamar al método insertarUsuario
        DAO dao = new DAO();
        boolean insertado = dao.insertarUsuario(rut, nombre, semestre, tipo_usuario, correo, carrera, contrasena);
        ...
        if (insertado) {
            ...
            JOptionPane.showMessageDialog(this, "Error al insertar el usuario.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmModalAgregarAdministradores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmModalAgregarAdministradores dialog = new frmModalAgregarAdministradores(new javax.swing.JFrame(), true);
